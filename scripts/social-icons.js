// Inline SVG glyphs for social icons (the source site uses a custom icon font).
// Shared by the footer and author-bio blocks.
export const SOCIAL_ICONS = {
  facebook: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.5 22v-8.2h2.77l.41-3.2H13.5V8.56c0-.93.26-1.56 1.59-1.56h1.7V4.14A22.8 22.8 0 0 0 14.31 4C11.85 4 10.2 5.49 10.2 8.24v2.36H7.43v3.2h2.77V22Z"/></svg>',
...
/**
 * Replace social link text with the matching SVG glyph. Matches on the link
 * label first ("Facebook"/"Twitter"/"Instagram") and falls back to the href,
 * since imported hrefs may point to the site root rather than the network.
 * The original label is kept as the accessible name.
 * @param {Element} container Element containing the social <a> links
 */
